      ...
      <header className="flex items-center justify-between max-w-6xl mx-auto mb-6">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="btn-outline bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md transition-colors"
          >
            + Adicionar Jogo
          </button>
          <a
            href="/"
            className="btn-outline border border-slate-600 hover:bg-slate-700 px-4 py-2 rounded-md text-slate-100 transition-colors"
          >
            Sair
          </a>
        </div>
